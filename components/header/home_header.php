    ...
    <div class="container w-100 d-flex justify-content-between">
      <div class="">
        <a class="navbar-brand" href="<?= BASE_URL. '/' ?>">
          <img src="http://smkpansa.sch.id/media_library/images/1468ab823038e7901c854e5445c8a664.png" alt="Logo" width="50" height="50" class="d-inline-block align-text-center  ">
          <STrong>PANSA</STrong>
        </a>
      </div>
      <div class="">
