...
<div style="background-color: #578FCA" class="container-fluid">
  <div class="container pt-5 px-2 pb-2">
    <div class="row justify-content-between">
      <div class="col-5">
        <h1 class="text-left">Universitas <span class="text-primary">SMK Pancasila 1</span> Kutoarjo</h1>
...
yang dapat bersaing di dunia  internasional</p>
      ...
      <div class="col-5">
        <img src="https://th.bing.com/th/id/OIP.KtMSPy2JlbmRLysDhvespAHaFj?w=231&h=180&c=7&r=0&o=7&dpr=1.6&pid=1.7&rm=3" alt="uwhs" class="rounded" widht="300" height="280">
      </div>
    </div>
  </div>
</div>
...
<div class="container py-3">
  <div class="text-center justify-content-center align-items-center d-flex flex-column my-5">
    <div class="w-50">
      <h1>Kenapa Harus Universitas <span class="text-primary">SMK Pancasila 1</span>Kutoarjo?</h1>
    </div>
  </div>
  <div class="row">
    <div class="col-md-3">
